__author__ = 'stefano'
from bilanci.views import BilancioNotFoundView, BilancioRedirectView, BilancioOverView, BilancioDettaglioView, BilancioComposizioneView, BilancioIndicatoriView, IncarichiVoceJSONView, IncarichiIndicatoriJSONView, BilancioCompositionWidgetView
from .views import BilancioOverServicesView
    # BilancioComposizioneServicesView, BilancioDettaglioServicesView, BilancioIndicatoriServicesView
