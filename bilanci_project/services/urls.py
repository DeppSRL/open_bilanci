...
from bilanci.views import BilancioOverView, BilancioDettaglioView, BilancioComposizioneView, BilancioIndicatoriView, \
    StaticPageView, PageNotFoundTemplateView, BilancioNotFoundView
...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<section>[-\w]+)/composizione$', BilancioComposizioneView.as_view(),
                           name='bilanci-composizione-services'),
                       url(r'^(?P<section>[-\w]+)/dettaglio$', BilancioDettaglioView.as_view(),
                           name='bilanci-dettaglio-services'),
